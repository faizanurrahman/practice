## Concept: Bytecode, constant pool, invokedynamic, and dispatch

### Mid-level

- Use `javap -c -v` to read constant pool and instruction shapes.
- Recognize `invokevirtual`, `invokeinterface`, `invokedynamic`, `invokespecial`, `invokestatic`.

### Senior

- Class file layout: constant pool, `Code`, `StackMapTable`; lambda bootstrap linkage.

### Staff

- Call-site stability, polymorphism shape, and JIT inlining / megamorphism cost.

### Checklist

- [ ] Explain `invokedynamic` for a lambda vs anonymous class (historical).
- [ ] Predict JIT pain from interface-heavy inner loops.

### Theory index

- [MidLevelBytecodeReadingWithJavap.md](theory/MidLevelBytecodeReadingWithJavap.md)
- [SeniorInvokeVirtualInterfaceAndVtable.md](theory/SeniorInvokeVirtualInterfaceAndVtable.md)
- [StaffInvokedynamicLambdaCost.md](theory/StaffInvokedynamicLambdaCost.md)
